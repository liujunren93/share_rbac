...
type RbacPath struct {
	...
	DomainID  int    `gorm:"domain_id;index;type:int;not null;default:-1;comment:'-1:公共'" json:"domain_id"`
...
type RbacPermission struct {
	...
	DomainID int    `gorm:"domain_id;index;type:int;not null;default:0;comment:'-1:基础权限，所有域通用'" json:"domain_id"`
