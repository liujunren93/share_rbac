...
type RbacPath struct {
	...
	PathType  int8   `gorm:"path_type;type:tinyint(1);not null;default:1;comment:'1:生成菜单;2:api'" json:"path_type,omitempty"`
	Meta      string `gorm:"meta;type:varchar(255);not null;default:'';comment:'meta{permission:}'" json:"meta,omitempty"`
	Method    string `gorm:"method;type:varchar(20);not null;default:'';comment:'method'" json:"method,omitempty"`
	ApiPath   string `gorm:"api_path;type:varchar(100);not null;default:'';comment:'api_path'" json:"api_path"`
